% % TotalData = readtable('H:\MATLAB\Project\Matlab Works\Data\User Rating - Movie Genre Splitted Data O.csv');
...
for i = 3467228 : row
    table_to_cell = table2cell(TotalData(i,1));
    user_id = cell2mat(table_to_cell);
    
    table_to_cell = table2cell(TotalData(i,2));
    movieId = cell2mat(table_to_cell);
    
    table_to_cell = table2cell(TotalData(i,3));
    rating = cell2mat(table_to_cell);
    
    
    table_to_cell = table2cell(TotalData(i,5));
...
% % 
% % writetable(averageRating , 'F:\NSU\172 Summer\CSE445\Project\Matlab Works\Data\AvgRating.csv');
% % writetable(ratioTable , 'F:\NSU\172 Summer\CSE445\Project\Matlab Works\Data\Ratio.csv');
% 
% 
